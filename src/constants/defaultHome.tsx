const bananaBread = {
    cookTime: "40 min - 55 min",
    description: "A baking classic courtesty of our good friend Allison! Easy to make with lots of room for customization!",
    name: "Allison's Banana Bread (wheat)",
    prepTime: "15 min",
    instructions: `
